...
public class TestComperatorId {

    @Test
    void eenAantalWerknemersSorterenOpIdDusNumeriekeVolgorde() {
        ...
        Arrays.sort(werkneemBaren, new WerknemerIdComparator()); //Deze regel is zeer belangrijk om de onderscheid te kunnen maken tussen id, naam en salaris
